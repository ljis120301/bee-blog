 ...
 *   ADMIN_PASSWORD - The admin password (hashed using Better Auth's own hashPassword)
 *
 * What it does:
 ...
 *
 * Run with: node scripts/ensure-admin.mjs
 */
...
async function ensureAdmin() {
    ...
    try {
        // Use Better Auth's own hashPassword to guarantee compatibility
        const hashedPassword = await hashPassword(adminPassword);
        console.log('[ENSURE-ADMIN] Password hashed using Better Auth crypto');
